...
function Home() {
    return (
        <main className="bg-[#FDFDF5] px-6 py-8">

            <section className="w-full max-w-[1208px] mx-auto bg-[#9FBAF1] rounded-3xl overflow-hidden shadow-lg">
            ...
            <section className="max-w-[1208px] mx-auto mt-12">

                <h2
                    className="text-3xl text-[#3D568F] mb-8"
                    style={{ fontFamily: "'Julius Sans One', sans-serif" }}
                >
                    CATEGORIAS
                </h2>
